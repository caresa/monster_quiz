...
ActiveRecord::Schema.define(version: 20140809163818) do
  ...
  create_table "options_meta", force: true do |t|
  ...
  add_index "options_meta", ["options_id"], name: "index_options_meta_on_options_id", using: :btree
